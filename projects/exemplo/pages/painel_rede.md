...
<!-- viewblock v1 {"v":1,"id":"vb_kpis","source":{"kind":"semantic","name":"comissoes"},"catalogHash":"d72794a6","queries":[{"name":"vb_kpis","sql":null}],"dims":[],"metrics":[{"name":"faturamento","alias":"faturamento","label":"Faturamento","fmt":"brl"},{"name":"comissoes","alias":"comissoes","label":"Comissões","fmt":"brl"},{"name":"atendimentos","alias":"atendimentos","label":"Atendimentos","fmt":"num0"},{"name":"ticket_medio","alias":"ticket_medio","label":"Ticket médio","fmt":"brl"}],"filters":[],"limit":1000,"params":[{"name":"ano","type":"enum","from":"tempo.ano","default":"%","label":"Ano"}],"style":"freeform","children":[]} -->
...
<!-- viewblock v1 {"v":1,"id":"vb_evolucao","source":{"kind":"semantic","name":"comissoes"},"catalogHash":"d72794a6","queries":[{"name":"vb_evolucao","sql":null}],"dims":[{"dim":"tempo","level":"mes","alias":"mes","column":"mes","table":"comissoes","label":"Tempo"}],"metrics":[{"name":"faturamento","alias":"faturamento","label":"Faturamento","fmt":"brl"}],"filters":[],"limit":1000,"params":[],"style":"graph.line","children":[]} -->
...
<LineChart data={vb_evolucao} x=mes y=faturamento yFmt=brl seriesLabels={["Faturamento"]}/>

<!-- /viewblock -->

## Faturamento por unidade

<!-- viewblock v1 {"v":1,"id":"vb_ranking","source":{"kind":"semantic","name":"comissoes"},"catalogHash":"d72794a6","queries":[{"name":"vb_ranking","sql":null}],"dims":[{"dim":"unidade","alias":"unidade","column":"unidade","table":"comissoes","label":"Unidade"}],"metrics":[{"name":"faturamento","alias":"faturamento","label":"Faturamento","fmt":"brl"}],"filters":[],"limit":1000,"params":[],"style":"graph.bar","children":[]} -->
...
<BarChart data={vb_ranking} x=unidade y=faturamento yFmt=brl seriesLabels={["Faturamento"]}/>

<!-- /viewblock -->

## Quem subiu e quem caiu no ranking

<!-- viewblock v1 {"v":1,"id":"vb_ranking_tempo","source":{"kind":"semantic","name":"comissoes"},"catalogHash":"d72794a6","queries":[{"name":"vb_ranking_tempo","sql":null}],"dims":[{"dim":"tempo","level":"ano","alias":"ano","column":"ano","table":"comissoes","label":"Tempo"},{"dim":"unidade","alias":"unidade","column":"unidade","table":"comissoes","label":"Unidade"}],"metrics":[{"name":"posicao_unidade","alias":"posicao_unidade","label":"Posição no ano","fmt":"num0"}],"filters":[],"limit":1000,"params":[],"style":"graph.bump","bump":{"top":5},"children":[]} -->

```sql vb_ranking_tempo
select * from (
-- semantic: comissoes@d72794a6
with base as (
  select year(cast("data" as date)) as "ano", "unidade", sum("valor") as "faturamento"
  from "comissoes"
  where cast(year(cast("data" as date)) as varchar) like '${inputs.ano.value}'
  group by 1, 2
)
, posicoes as (
  select "ano", "unidade", "faturamento", rank() over (partition by "ano" order by "faturamento" desc) as "__pos_faturamento_ano"
  from base
)
select "ano", "unidade", "__pos_faturamento_ano" as "posicao_unidade"
from posicoes
where ("unidade") in (select "unidade" from posicoes where "__pos_faturamento_ano" <= 5)
order by "posicao_unidade" desc
limit 1000
) t
order by "ano"
```

<LineChart data={vb_ranking_tempo} x=ano y=posicao_unidade series=unidade yInverted=true yAxisTitle="Posição no ano"/>

<!-- /viewblock -->

## Desempenho por serviço

<!-- viewblock v1 {"v":1,"id":"vb_servicos","source":{"kind":"semantic","name":"comissoes"},"catalogHash":"d72794a6","queries":[{"name":"vb_servicos","sql":null}],"dims":[{"dim":"servico","alias":"servico","column":"servico","table":"comissoes","label":"Serviço"}],"metrics":[{"name":"atendimentos","alias":"atendimentos","label":"Atendimentos","fmt":"num0"},{"name":"faturamento","alias":"faturamento","label":"Faturamento","fmt":"brl"},{"name":"ticket_medio","alias":"ticket_medio","label":"Ticket médio","fmt":"brl"},{"name":"pct_faturamento","alias":"pct_faturamento","label":"% do total","fmt":"pct1"}],"filters":[],"limit":1000,"params":[],"style":"tabular","children":[]} -->
...
<DataTable data={nav_unidade} link=link search=true><Column id=unidade title="Por unidade"/></DataTable>
